...
package reversi.controller
{
	...
	public class BotController
	{
		...
		private function calculateMove():void
		{
			...
			{
				if(findNaiboringMove(TOP_LEFT_CORNER, new Point(1, 0), BoardModel.SIZE_BOARD - 2))
				{
					return;
				}
				if(findNaiboringMove(TOP_LEFT_CORNER, new Point(0, 1), BoardModel.SIZE_BOARD - 2))
				{
					return;
				}
			}
			...
			{
				if(findNaiboringMove(TOP_RIGHT_CORNER, new Point(-1, 0), BoardModel.SIZE_BOARD - 2))
				{
					return;
				}
				if(findNaiboringMove(TOP_RIGHT_CORNER, new Point(0, 1), BoardModel.SIZE_BOARD - 2))
				{
					return;
				}
			}
			...
			{
				if(findNaiboringMove(BOTTOM_RIGHT_CORNER, new Point(-1, 0), BoardModel.SIZE_BOARD - 2))
				{
					return;
				}
				if(findNaiboringMove(BOTTOM_RIGHT_CORNER, new Point(0, -1), BoardModel.SIZE_BOARD - 2))
				{
					return;
				}
			}
			...
			{
				if(findNaiboringMove(BOTTOM_LEFT_CORNER, new Point(1, 0), BoardModel.SIZE_BOARD - 2))
				{
					return;
				}
				if(findNaiboringMove(BOTTOM_LEFT_CORNER, new Point(0, -1), BoardModel.SIZE_BOARD - 2))
				{
					return;
				}
			}

			if(findNaiboringMove(TOP_TOP_LEFT, new Point(1, 0), BoardModel.SIZE_BOARD / 2))
			{
				return;
			}
			if(findNaiboringMove(TOP_BOTTOM_RIGHT, new Point(0, 1), BoardModel.SIZE_BOARD / 2))
			{
				return;
			}
			if(findNaiboringMove(BOTTOM_BOTTOM_RIGHT, new Point(-1, 0), BoardModel.SIZE_BOARD / 2))
			{
				return;
			}
			if(findNaiboringMove(BOTTOM_TOP_LEFT, new Point(0, -1), BoardModel.SIZE_BOARD / 2))
			{
				return;
			}
		...
		private static function comparePoint(point1:Point, point2:Point):Boolean
		{
			return point1.x == point2.x && point1.y == point2.y;
		}

		private static function findNaiboringMove(point:Point, factor:Point, depth:uint):Boolean
		{
		...
		public function set isThink(value:Boolean):void
		{
			_isThink = value;
		}
	}
