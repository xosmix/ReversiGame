...
package reversi.controller
{
	...
	import reversi.model.IPlayerModel;
	import reversi.view.CellView;
	...
	public class HumanController implements IHumanController
	{
		...
		{
			if(_bot == null || _model.currentColor != _bot.color && !_bot.isThink)
			{
				makeMove(point);
			}
			else if(_model.currentColor == _bot.color && !_bot.isThink)
			{
				_bot.takeCell();
			}
		}
