...
package reversi.view
{
	...
	public class ScoreGameView extends DisplayObjectContainer
	{
		...
		{
			var background:Image = new Image(AssetsManager.getTextureByName(TextureHelper.SCORE));
			addChild(background);
		}
		...
		{
			_blackStone = new Image(AssetsManager.getTextureByName(TextureHelper.BLACK_STONE));
			_whiteStone = new Image(AssetsManager.getTextureByName(TextureHelper.WHITE_STONE));
